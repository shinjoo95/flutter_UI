...
class ShoppingCartDetail extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Icon(Icons.star, color: Colors.yellow),
          Icon(Icons.star, color: Colors.yellow),
          // Spacer()로 Icon위젯과 Text위젯을 양끝으로 벌릴 수 있다. spaceBetween과 동일
          Spacer(),
          Text("review "),
  ...
  Widget _buildDetailIcon(Color mColor) {
    return Padding(
      ...
      // Stack의 첫 번째 Container 위젯위에 Positioned 위젯이 올라가는 형태
      child: Stack(
        children: [
          Container(
            width: 50,
  ...
  // 다른 화면에서도 재사용하려면 함수가 아닌 공통 컴포넌트 위젯으로 관리하는 것이 좋음.
